...
public class connect3 {
	...
	String name=null;
	String password=null;//name和password没有用，主要接受uroot padim
	String account=null;//存储开户时存储的账户
	int salary=0;
	public connect3()
	{
		;
	...
	public int insert1(String id,String name,String password) 
	{ 
		//String id;
		//String account;
		//String name;
	...
	public int  search1(String account,String password)
	{
	...
	public int addmoney1(String account,String password,float money)
	{
		 //float money;
		 //System.out.println("输入存款金额");
		// Scanner in = new Scanner(System.in);			
	...
	public int  Jianmoney1(String account,String password,float money)
	{
	...
	public boolean guashi1(String account ,String password)
	{
		if(search(account,password))
		{
			String sql;
	...
	public boolean searchaccount1(String account)
	{
	...
	public int  zhuang1(String account,String password,String acc,float money)
	{
		   ...
		   // Scanner in = new Scanner(System.in);	
			...
			if(searchaccount(acc))
			{
				...
				//float money;
				//money=in.nextFloat();
				int a=Jianmoney1(account,password,money);
				if(a==1)
				{
				  addzhuang(acc,money);
				  //System.out.println("转账成功: -"+money+"   to   "+acc);
	...
	public float yumoney1(String account ,String password)
	{
	...
	public boolean zhuxiao1(String account,String password)
	{
		if(search(account,password))
		{				
				String duan="delete from employertable where account=";	
	...
	public int inuse1(String account,String password)
	{

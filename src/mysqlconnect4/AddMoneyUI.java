...
public class AddMoneyUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddMoneyUI frame = new AddMoneyUI();
	...
	public AddMoneyUI() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(MainLoginUI.cn.addmoney1(MainLoginUI.getaccount(),MainLoginUI.getpassword(), money)==1)
				{
				JOptionPane.showMessageDialog(null,"存款成功:+"+money,"提示消息",JOptionPane.WARNING_MESSAGE);
				return ;//+money
				}
			}
			}
